...
function exampleActive(event: Event) {
   if (event instanceof MouseEvent) console.log(event.pageX);
   if (event instanceof TouchEvent) console.log(event.touches[0].clientX);
}
...
// Exemplo 02
function handleClick02(event: MouseEvent) {
...
function handleActiveMenu(event: PointerEvent) {
